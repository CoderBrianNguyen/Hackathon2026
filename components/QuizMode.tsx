      ...
      <article className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        ...
        {submissionState === "idle" ? (
          ...
          <div className="mt-4 space-y-3">
            ...
            >
              {submissionState === "instant" && submittedResult === true && <p className="font-semibold">Correct</p>}
              {submissionState === "instant" && submittedResult === false && <p className="font-semibold">Incorrect</p>}
              {submissionState === "deferred" && (
                <div className="flex items-center gap-2">
                  <Clock size={16} />
                  <p className="font-semibold">Evaluation Deferred</p>
                </div>
              )}
              <p>
            ...
            >
              {submissionState === "instant" && submittedResult === true && <CheckCircle size={16} />}
              {submissionState === "instant" && submittedResult === false && <XCircle size={16} />}
              {submissionState === "deferred" && <Clock size={16} />}
